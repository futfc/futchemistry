...
function EULA() {
  return (
    <>
      <Head>
        <title>EULA &#8211; FUT Chemistry | Optimize your FUT Squad</title>
      </Head>
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            <p>
              ...
              agreement between you and FUT Chemistry;
            </p>
            <p>
              This EULA agreement governs your acquisition and use of our
              FUT Chemistry software (&quot;Software&quot;) directly from FUT Chemistry or
              indirectly through a FUT Chemistry authorized reseller or distributor
              (a &quot;Reseller&quot;).
            </p>
            <p>
              Please read this EULA agreement carefully before completing the
              installation process and using the FUT Chemistry software. It provides
              a license to use the FUT Chemistry software and contains warranty
              information and liability disclaimers.
            </p>
            <p>
              If you register for a free trial of the FUT Chemistry software, this
              EULA agreement will also govern that trial. By clicking
              &quot;accept&quot; or installing and/or using the FUT Chemistry
            ...
            <p>
              ...
              FUT Chemistry herewith regardless of whether other software is referred
              to or described herein. The terms also apply to any FUT Chemistry
            ...
            <h2>License Grant</h2>
            <p>
              FUT Chemistry hereby grants you a personal, non-transferable,
              non-exclusive licence to use the FUT Chemistry software on your devices
              in accordance with the terms of this EULA agreement.
            </p>
            <p>
              You are permitted to load the FUT Chemistry software (for example a PC,
            ...
            <ul role="list">
              ...
              <li>
                Use the Software for any purpose that FUT Chemistry considers is a
                breach of this EULA agreement.
              </li>
            </ul>
            <h2>Intellectual Property and Ownership</h2>
            <p>
              FUT Chemistry shall at all times retain ownership of the Software as
              ...
              property of FUT Chemistry.
            </p>
            <p>
              FUT Chemistry reserves the right to grant licences to use the Software
              to third parties.
            </p>
            <h2>Termination</h2>
            <p>
              ...
              at any time upon written notice to FUT Chemistry.
            </p>
            <p>
            ...
            <h2>Disclaimer</h2>
            <p>
              You expressly understand and agree that the FUT Chemistry software, the
              FUT Chemistry software content and third party content are provided on
              ...
              enjoyment, or non-infringement. The FUT Chemistry software may include
              Inaccuracies or typographical errors we make, and there are no
              Representations, warranties or conditions regarding the FUT Chemistry
              Software, the FUT Chemistry software content or the third party content
              made Available through the FUT Chemistry software, and we specifically
              disclaim Any representation, warranty or condition as to the
              suitability, Reliability, timeliness or accuracy of the FUT Chemistry
              software content or The third party content made available through
              the FUT Chemistry software for Any purpose whatsoever. Furthermore, we
            ...
            <ul role="list">
              <li>
                ...
                FUT Chemistry software, the FUT Chemistry software content or any third
                party content or any website which you access from the FUT Chemistry
                software;
              </li>
              <li>
                Any third party claims that the access or use by you of the
                FUT Chemistry software, the FUT Chemistry software content or the third
                party content violates any intellectual property or proprietary
                right;
              </li>
              <li>
                Any failure of performance of the FUT Chemistry software, the
                FUT Chemistry software content or any third party content, whether
                related to error, omission, interruption, defect, delay in
                operation or transmissions, computer viruses or line failure, or
                any other operational issue; or
              </li>
              <li>
                Any other matters relating to the FUT Chemistry software, the
                FUT Chemistry software content or the third party content.
              </li>
            </ul>
            <p>
              You specifically acknowledge that we are not liable for the
              defamatory, Offensive or illegal conduct of any third parties and
              that the risk of Injury from the foregoing rests entirely with
              you.
            </p>
            <h2>Indemnity and Discharge</h2>
            <p>
              ...
              consultants and advisors from and against any claims, losses,
              judgements, damages, costs and expenses (including, without
              limitation, reasonable legal fees), incurred by any of the
              foregoing parties due to or resulting from Your use of the
              FUT Chemistry software, the FUT Chemistry software Content or the Third
              Party Content or Your violation of these Terms of Use. You will
            ...
            <p>
              ...
              <strong>futfc.team@gmail.com</strong>.
            </p>
          </div>
        </div>
      </div>
