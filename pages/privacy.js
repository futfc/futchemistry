...
function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy &#8211; FUT Chemistry | Optimize FUT SQUAD</title>
      </Head>
      ...
      <div className="relative py-16 bg-white overflow-hidden">
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            <p>
              We have built FUT Chemistry as an ad supported app. This SERVICE is
              provided by FUT Chemistry software at no cost and is intended for use
              as is.
            </p>
            <p>
            ...
            <p>
              ...
              our End-User License Agreement, which are accessible at FUT Chemistry
